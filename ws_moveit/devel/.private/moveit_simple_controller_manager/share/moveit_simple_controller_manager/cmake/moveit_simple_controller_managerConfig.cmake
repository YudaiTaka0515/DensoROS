...
if("TRUE" STREQUAL "TRUE")
  set(moveit_simple_controller_manager_SOURCE_PREFIX /workspace/ws_moveit/src/moveit/moveit_plugins/moveit_simple_controller_manager)
  set(moveit_simple_controller_manager_DEVEL_PREFIX /workspace/ws_moveit/devel/.private/moveit_simple_controller_manager)
  ...
  set(moveit_simple_controller_manager_INSTALL_PREFIX /workspace/ws_moveit/install)
...
if(NOT "/workspace/ws_moveit/src/moveit/moveit_plugins/moveit_simple_controller_manager/include " STREQUAL " ")
  set(moveit_simple_controller_manager_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/ws_moveit/src/moveit/moveit_plugins/moveit_simple_controller_manager/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_simple_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/ws_moveit/src/moveit/moveit_plugins/moveit_simple_controller_manager/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/ws_moveit/devel/.private/moveit_simple_controller_manager/lib;/workspace/ws_moveit/devel/lib;/opt/ros/melodic/lib)
