...
set(MSG_I_FLAGS "-Ibcap_service:/workspace/ws_denso/src/denso_robot_ros/bcap_service/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/workspace/ws_denso/src/denso_robot_ros/bcap_service/msg/variant.msg" NAME_WE)
add_custom_target(_bcap_service_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bcap_service" "/workspace/ws_denso/src/denso_robot_ros/bcap_service/msg/variant.msg" ""
)

get_filename_component(_filename "/workspace/ws_denso/src/denso_robot_ros/bcap_service/srv/bcap.srv" NAME_WE)
add_custom_target(_bcap_service_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bcap_service" "/workspace/ws_denso/src/denso_robot_ros/bcap_service/srv/bcap.srv" "bcap_service/variant"
)
...
_generate_msg_cpp(bcap_service
  "/workspace/ws_denso/src/denso_robot_ros/bcap_service/msg/variant.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(bcap_service
  "/workspace/ws_denso/src/denso_robot_ros/bcap_service/srv/bcap.srv"
  "${MSG_I_FLAGS}"
  "/workspace/ws_denso/src/denso_robot_ros/bcap_service/msg/variant.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/bcap_service
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/bcap_service)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/bcap_service\")")
  # install generated code
  install(
