...
if("TRUE" STREQUAL "TRUE")
  set(rviz_visual_tools_SOURCE_PREFIX /workspace/ws_moveit/src/rviz_visual_tools)
  set(rviz_visual_tools_DEVEL_PREFIX /workspace/ws_moveit/devel/.private/rviz_visual_tools)
  ...
  set(rviz_visual_tools_INSTALL_PREFIX /workspace/ws_moveit/install)
...
if(NOT "/workspace/ws_moveit/src/rviz_visual_tools/include;/usr/include/OGRE " STREQUAL " ")
  set(rviz_visual_tools_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/ws_moveit/src/rviz_visual_tools/include;/usr/include/OGRE")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_visual_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/ws_moveit/src/rviz_visual_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/ws_moveit/devel/.private/rviz_visual_tools/lib;/workspace/ws_moveit/devel/lib;/opt/ros/melodic/lib)
