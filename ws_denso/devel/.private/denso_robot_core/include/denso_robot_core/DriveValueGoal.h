...
struct DriveValueGoal_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::denso_robot_core::Joints_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::denso_robot_core::Joints_<ContainerAllocator> >::other >  _pose_type;
  _pose_type pose;
...
struct Printer< ::denso_robot_core::DriveValueGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::denso_robot_core::DriveValueGoal_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.pose.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::denso_robot_core::Joints_<ContainerAllocator> >::stream(s, indent + "    ", v.pose[i]);
    }
    s << indent << "pass: ";
