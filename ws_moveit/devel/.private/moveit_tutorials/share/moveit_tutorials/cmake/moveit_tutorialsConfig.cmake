...
if("TRUE" STREQUAL "TRUE")
  set(moveit_tutorials_SOURCE_PREFIX /workspace/ws_moveit/src/moveit_tutorials)
  set(moveit_tutorials_DEVEL_PREFIX /workspace/ws_moveit/devel/.private/moveit_tutorials)
  ...
  set(moveit_tutorials_INSTALL_PREFIX /workspace/ws_moveit/install)
...
if(NOT "/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/ws_moveit/src/moveit_tutorials/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/ws_moveit/devel/.private/moveit_tutorials/lib;/workspace/ws_moveit/devel/lib;/opt/ros/melodic/lib)
