...
if("TRUE" STREQUAL "TRUE")
  set(moveit_resources_prbt_moveit_config_SOURCE_PREFIX /workspace/ws_moveit/src/moveit_resources/prbt_moveit_config)
  set(moveit_resources_prbt_moveit_config_DEVEL_PREFIX /workspace/ws_moveit/devel/.private/moveit_resources_prbt_moveit_config)
  ...
  set(moveit_resources_prbt_moveit_config_INSTALL_PREFIX /workspace/ws_moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_resources_prbt_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/ws_moveit/src/moveit_resources/prbt_moveit_config/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/ws_moveit/devel/.private/moveit_resources_prbt_moveit_config/lib;/workspace/ws_moveit/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND moveit_resources_prbt_moveit_config_EXPORTED_TARGETS ${${moveit_resources_prbt_moveit_config_dep}_EXPORTED_TARGETS})
endforeach()
