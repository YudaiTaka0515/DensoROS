...
if("TRUE" STREQUAL "TRUE")
  set(geometric_shapes_SOURCE_PREFIX /workspace/ws_moveit/src/geometric_shapes)
  set(geometric_shapes_DEVEL_PREFIX /workspace/ws_moveit/devel/.private/geometric_shapes)
  ...
  set(geometric_shapes_INSTALL_PREFIX /workspace/ws_moveit/install)
...
if(NOT "/workspace/ws_moveit/src/geometric_shapes/include;/usr/include/eigen3;/opt/ros/melodic/include;/usr/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/ws_moveit/src/geometric_shapes/include;/usr/include/eigen3;/opt/ros/melodic/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/ws_moveit/src/geometric_shapes/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/ws_moveit/devel/.private/geometric_shapes/lib;/workspace/ws_moveit/devel/lib;/opt/ros/melodic/lib)
